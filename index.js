  ...
  constructor() {
    this.required = {
      ...
      validate: (value) => {
        ...
        if (value === "" || value === null) return this.required.message;
    ...
    this.cpf_cnpj = {
      regex: /^\d{2}\.\d{3}\.\d{3}\/\d{4}\-\d{2}$/,
      validate: (value) => {
        if (this.cnpj.regex.test(value)) {
          if (!isCnpjValid(value)) return this.cnpj.message;
          return null;
        }

        if (this.cpf.regex.test(value)) {
          if (!isCpfValid(value)) return this.cpf.message;
          return null;
        }
    ...
    this.numbers = {
      ...
      validate: (value) => {
        if (value !== null) {
          if (isNaN(value)) return this.numbers.message;
        }
        return null;
      },
    };
    ...
    this.doubleFormat = {
      message: "Formato inválido. Use ponto(.) para separação decimal",
      regex: /^-?(\d*\.)?\d*$/,
      validate: (value) => {
        if (value) {
          if (!this.doubleFormat.regex.test(value))
            return this.doubleFormat.message;
          return null;
        }
      },
    };
